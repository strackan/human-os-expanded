                ...
                },
                {
                  ...
                  props: {
                    ...
                    contacts: context?.variables?.contacts || [
                      { name: 'Sarah Johnson', role: 'VP of People', type: 'executive', confirmed: true },
                      { name: 'Mike Chen', role: 'HR Director', type: 'champion', confirmed: true },
                      { name: 'Lisa Park', role: 'Talent Acquisition Lead', type: 'business', confirmed: false },
                    ],
                  },
                },
                {
