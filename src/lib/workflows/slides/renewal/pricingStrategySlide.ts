            ...
            data: {
              ...
              props: {
                recommendation: context?.variables?.recommendedStrategy || {
                  targetPrice: context?.variables?.proposedARR || 0,
                  increasePercent: context?.variables?.changePercent || 0,
                  increaseAmount: context?.variables?.changeAmount || 0,
                  confidence: context?.variables?.confidence || 75,
                  scenarios: [
                    {
                    ...
                    },
                    {
                      ...
                      increaseAmount: 0,
                      probability: 85,
                      pros: ['Balanced approach', 'Market-aligned'],
