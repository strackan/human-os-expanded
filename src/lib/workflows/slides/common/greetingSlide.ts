...
const GREETING_TEMPLATES = {
  executive_departure: "[DEBUG:SLIDE_LIBRARY] {{departed_contact.name}} has left {{customer.name}}. Let's maintain our relationship strength.",
  renewal_preparation: "[DEBUG:SLIDE_LIBRARY] {{customer.name}}'s renewal is coming up. Let's prepare a strategic plan.",
  expansion_opportunity: "[DEBUG:SLIDE_LIBRARY] Expansion opportunity at {{customer.name}}. Let's explore!",
  account_review: "[DEBUG:SLIDE_LIBRARY] Time for {{customer.name}}'s account review.",
  churn_risk: "[DEBUG:SLIDE_LIBRARY] {{customer.name}} is showing churn risk signs. Let's address proactively.",
  default: "[DEBUG:SLIDE_LIBRARY] Let's work on {{customer.name}}.",
};
