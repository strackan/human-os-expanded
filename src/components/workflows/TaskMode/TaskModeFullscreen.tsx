...
export default function TaskModeFullscreen(props: TaskModeFullscreenProps) {
  ...
  // Resume check state (simplified - auto-resume without dialog)
  ...
  useEffect(() => {
    ...
    const checkForResume = async () => {
      ...
      try {
        ...
        if (resumable) {
          console.log('[TaskModeFullscreen] Found resumable execution, auto-resuming:', {
          ...
          setEffectiveExecutionId(resumable.executionId);
          setIsCheckingResume(false);
  ...
  // Resume check loading state (also shown during auto-resume)
  if (isCheckingResume) {
    return (
