...
export default function TaskModeFullscreen({
  ...
  // Load workflow context (customer, expansion data, stakeholders) from database
  ...
  // Data now comes from useWorkflowContext hook (expansionData, stakeholders)
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto">
              {contextLoading ? (
                // Show loading state while fetching workflow context
                ...
                <div className="flex items-center justify-center p-12 h-full">
                  <div className="max-w-md text-center">
                    ...
                    <p className="text-gray-600 mb-4">{contextError.message}</p>
                    <button
