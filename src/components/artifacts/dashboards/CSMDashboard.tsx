...
import {
  ...
  // NOTE: acoStrategicPlanningConfig deprecated - now using WorkflowExecutor with dynamic factory
...
const CSMDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    generateWorkflow();
  }, [modalConfig, showTaskModal, generatedWorkflows]);
  ...
  // Get current workflow (check both systems: static, generated, and legacy config)
