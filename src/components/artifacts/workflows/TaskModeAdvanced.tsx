...
const TaskModeModal = ({ 
  ...
  const [isSplitMode, setIsSplitMode] = useState(artifact_visible);
  ...
  const handleButtonClick = (buttonValue, buttonLabel, messageId) => {
    ...
    // You can add custom logic here based on buttonValue
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <div className="space-y-4 text-sm">
                    <div className="flex justify-between items-center py-2 border-b border-gray-100">
                      ...
                      <span className="font-medium">100,000 tokens @ $4.85 - <strong>$485,000</strong></span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-gray-100">
                      <span className="text-gray-600">Anticipated Renewal Cost:</span>
                      <span className="font-medium">170,000 tokens @ $4.85 = <strong>$824,500</strong></span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-gray-100">
                      <span className="text-gray-600">Early Renewal Discount:</span>
                      <span className="font-medium text-orange-600">10% - <strong>$742,050</strong></span>
                    </div>
                    <div className="flex justify-between items-center py-2">
                      <span className="text-gray-600">Multi-year Discount:</span>
                      <span className="font-medium text-green-600">22% - <strong>$643,110</strong></span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4 text-sm">
                    <div className="grid grid-cols-3 gap-4 text-xs text-gray-500 border-b border-gray-100 pb-4">
                      ...
                      <div>
                        ...
                        <span>Account Review - Usage Update</span>
                      </div>
                      <div>
                    ...
                    <div className="space-y-4 leading-relaxed">
                      ...
                      <p>I've been reviewing your account, and it looks like your usage has increased substantially over the past month. I wanted to set a meeting to review the impact on your license fees so we can make sure there are no surprises come budget time.</p>
                      
                      <p>I am free next Tuesday morning from 9am to 12pm PST. Can we find some time to connect?</p>
                      
                      <div className="mt-6 pt-4 border-t border-gray-100">
                        <p className="text-gray-600">Best regards,<br/>Justin</p>
                      </div>
                    </div>
                  </div>
                </div>
...
const Demo = () => {
  ...
  // AcmeCorp renewal conversation seed
  ...
  return (
    <>
      <TaskModeModal
        ...
        artifact_visible={true} // Start with artifacts enabled
