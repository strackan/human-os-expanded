...
export default function DailyBountyStrip({ earned, goal, streak, message }: DailyBountyStripProps) {
  ...
  return (
    ...
    >
      ...
      <span className="text-2xl font-bold mr-4 leading-none text-gradient-bounty">
        {earned}
      </span>
      ...
      <div className="flex-1 h-1.5 bg-gray-200 rounded-full overflow-hidden mr-3 min-w-[80px]">
        <motion.div
          className="h-full rounded-full bg-bounty-gradient"
          initial={{ width: 0 }}
      ...
      {(message || streak > 0) && (
        <>
          ...
          <div className="flex items-center gap-1.5 whitespace-nowrap">
            <svg className="w-3.5 h-3.5 text-bounty-orange" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
            </svg>
            <span className="text-sm font-semibold text-bounty-orange">
