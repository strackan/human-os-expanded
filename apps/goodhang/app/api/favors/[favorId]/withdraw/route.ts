...
/**
 * POST /api/favors/[favorId]/withdraw
...
export async function POST(_request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const result = await favorService.withdrawFavor(favorId, user.id);
    ...
    console.error('Error in POST /api/favors/[favorId]/withdraw:', error);
    return NextResponse.json(
