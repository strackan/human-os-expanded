-- COMPLETE UPGRADE TO DATABASE VERSION 1.4.0
-- This script can be run on any database from v1.0.0 to v1.4.0
...
SELECT 
    'Database upgraded to v1.4.0' as message,
    ...
    (SELECT COUNT(*) FROM entries) as journal_entries,
...
-- Version: 1.4.0
-- Purpose: Complete upgrade from v1.0.0 to v1.4.0
-- Components: User mood preferences, emotion suggestions, analytics, user moods, mood promotions
-- Safety: All CREATE TABLE IF NOT EXISTS, no data deletion, preserves existing data
